...
<html lang="pt-br" dir="ltr">
  ...
  <link href="{{ asset('backend/assets/plugins/select2/css/select2.min.cs') }}s" rel="stylesheet" />
  <link href="{{ asset('backend/assets/plugins/daterangepicker/daterangepicker.css') }}" rel="stylesheet" />

  <!-- SLEEK CSS -->
  <link id="sleek-css" rel="stylesheet" href="{{ assets('backend/assets/css/sleek.css') }}" />
...
<script src=" {{assets('backend/assets/plugins/jquery/jquery.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/toaster/toastr.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/slimscrollbar/jquery.slimscroll.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/charts/Chart.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/ladda/spin.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/ladda/ladda.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/jquery-mask-input/jquery.mask.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/select2/js/select2.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/daterangepicker/moment.min.j') }}s"></script>
<script src=" {{assets('backend/assets/plugins/daterangepicker/daterangepicker.js') }}"></script>
<script src=" {{assets('backend/assets/plugins/jekyll-search.min.js') }}"></script>
<script src=" {{assets('backend/assets/js/sleek.js') }}"></script>
<script src=" {{assets('backend/assets/js/chart.js') }}"></script>
<script src=" {{assets('backend/assets/js/date-range.js') }}"></script>
<script src=" {{assets('backend/assets/js/map.js') }}"></script>
<script src=" {{assets('backend/assets/js/custom.js') }}"></script>
